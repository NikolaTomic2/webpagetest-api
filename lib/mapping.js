...
var options = {
  ...
  results: {
    ...
    nostandard: {
      ...
      bool: true,
      invert: true,
      info: "remove the standard deviation run",
    },
    noruns: {
      name: "noruns",
      api: "runs",
      bool: true,
      invert: true,
      info: "remove the different runs",
    },
    noconsole: {
      name: "noconsole",
      api: "console",
      bool: true,
      invert: true,
      info: "remove the console message",
    },
    nolighthouse: {
      name: "nolighthouse",
      api: "lighthouse",
      bool: true,
      invert: true,
      info: "remove the lighthouse report",
    },
    norepeatview: {
      name: "norepeatview",
      key: "v",
      ...
      bool: true,
      invert: true,
      info: "remove the repeat view in the response",
    },
    norequests: {
      name: "norequests",
      api: "requests",
      bool: true,
      invert: true,
      info: "remove the request data in the response",
    },
    basiconly: {
      name: "basiconly",
      api: "basic",
      bool: true,
      info: "include only basic report in the response",
    },
    median: {
      name: "medianMetric",
      key: "m",
  ...
  lighthouse: {
    lighthouseConfig: {
      ...
      key: "lighthouseConfig",
      api: "lighthouseConfig",
      param: "lighthouseConfig",
      info: "Lighthouse config (optional). Base64 encoded lighthouse config JSON",
    },
  },
  video: {
    end: {
